      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <ContactCard
            icon={Mail}
            title="Email"
            content="rimshaashraf.20034@gmail.com"
            link="mailto:rimshaashraf.20034@gmail.com"
            delay={0.1}
            color="indigo"
          />
          ...
          <ContactCard
            icon={Phone}
            title="Phone"
            content="+92 - 3045646432"
            link="tel:+923045646432"
            delay={0.2}
            color="blue"
          />
          ...
          <ContactCard
            icon={MapPin}
            title="Location"
            content="Sargodha, Punjab, Pakistan"
            link="#"
            delay={0.3}
            color="purple"
          />
