...
export default function Projects() {
  ...
  const categories = [
    { id: "AI", label: "Mobile Apps", icon: <Cpu className="w-4 h-4" /> },
  ...
  const projects = [
    {
      title: "Memi",
      description: "Memi is an wallpaper app built using React Native with Expo that allows users to explore, download, and set high-quality wallpapers from their device",
      techStack: "React Native",
      link: "https://github.com/Rimshaaaa/WallpaperApp",
    ...
    {
      title: "Attendance Managment App",
      description: "Attendance managment system for teachers to manage students atendance",
      techStack: "Flutter",
      link: "https://github.com/Rimshaaaa/AttendanceApp/",
    ...
    {
      title: "AR Based E-commerce website",
      description: "AR based E-commerce platform for an immersive shopping experience with product visualizations.",
      techStack: "React.js, Tailwind CSS, MySQL, ARCore",
      link: "https://armodel12.netlify.app/",
  ...
  return (
    <section id="projects" className="py-20 relative overflow-hidden bg-slate-950">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <SectionHeading
          title="Projects"
          subtitle="Explore my portfolio of mobile and web applications"
        />
