...
const CodeEditorAnimation = () => {
  ...
  useEffect(() => {
    ...
    const codeLines = [
      { text: "// Mobile App developer Portfolio", color: colors.comment },
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 font-display">
            <span className="text-white">
              <TypingAnimation text="I'm Rimsha Ashraf"/>
          ...
          >
            Building next-gen mobile experiences with React Native and hybrid frameworks. Turning ideas into seamless, cross-platform apps that blend performance, design, and innovation
          </motion.p>
          ...
          >
            <a
              href="https://www.linkedin.com/in/rimshashraf/"
            ...
            <a
              href="mailto:rimshaashraf.20034@gmail.com"
              className="p-3 rounded-full bg-slate-800/80 backdrop-blur-sm border border-slate-700 hover:bg-indigo-600 hover:border-indigo-500 transition-all duration-300"
            ...
            {/* <a
              href="https://github.com/Rimshaaaa"
              className="p-3 rounded-full bg-slate-800/80 backdrop-blur-sm border border-slate-700 hover:bg-indigo-600 hover:border-indigo-500 transition-all duration-300"
