  ...
  const skills = [
    {
      ...
      description: "React Native, JavaScript, TypeScript, React.js, Tailwind CSS",
    },
    {
      icon: <Server className="w-8 h-8 text-blue-400" />,
      title: "Tools & Frameworks",
      description: "Expo, Redux, Postman, Git, Firebase",
    },
    {
      icon: <Database className="w-8 h-8 text-violet-400" />,
      title: "Database & Cloud Integration",
      description: "Firebase (auth, real-time DB, cloud functions)",
    },
    {
          ...
          >
            <div className="bg-slate-900/80 backdrop-blur-md p-8 rounded-2xl border border-indigo-500/20">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-white font-display">Mobile App Developer & Cross-Platform Specialist</h3>
              </div>

              <p className="text-xl text-slate-300 leading-relaxed mb-6">
               Specializing in React Native, Hybrid App Development, and UI/UX. Skilled in JavaScript, React.js, Firebase, Expo, Redux, and Git, with hands-on experience in push notifications, authentications and cloud integration.
              </p>
              <p className="text-xl text-slate-300 leading-relaxed">
                  Passionate about crafting seamless, scalable mobile experiences and turning ideas into polished, high-performance apps across iOS and Android platforms.
              </p>
            </div>
          </motion.div>
